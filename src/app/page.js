  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans" style={{ scrollBehavior: 'smooth' }}>
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-blue-600 rounded-full opacity-20 blur-2xl animate-float1 top-[10%] left-[5%]" />
        <div className="absolute w-24 h-24 sm:w-32 sm:h-32 md:w-32 md:h-32 bg-blue-500 rounded-full opacity-15 blur-xl animate-float2 top-[65%] right-[15%]" />
        <div className="absolute w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 bg-blue-400 rounded-full opacity-25 blur-lg animate-float3 bottom-[15%] left-[25%]" />
        <div className="absolute w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-blue-300 rounded-full opacity-20 blur-md animate-float4 top-[35%] right-[5%]" />
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        ...
        <section id="wash-categories" className="py-16 px-4 sm:py-24 bg-gradient-to-b from-black via-blue-900/20 to-gray-800 relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute bottom-1/3 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
            <div className="absolute top-1/2 left-1/2 w-48 sm:w-64 h-48 sm:h-64 bg-blue-400/10 rounded-full blur-3xl animate-pulse delay-500"></div>
          </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-white via-blue-200 to-cyan-200 bg-clip-text text-transparent tracking-tight mb-4">
                Our Wash Packages
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 sm:mb-20">
              {washCategories.map((category, i) => (
                <div
                  key={i}
                  className="group relative bg-gradient-to-br from-gray-900/90 to-gray-950/90 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border border-gray-700/50 shadow-2xl hover:border-blue-500/70 hover:shadow-blue-500/20 transition-all duration-500 hover:scale-105 hover:-translate-y-2"
                >
                  {/* Glow Effect */}
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-6 group-hover:text-blue-100 transition-colors duration-300">
                      {category.title}
                    </h3>
            ...
            <div id="booking-form" className="relative">
              ...
              <div className="text-center mb-12">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-white via-cyan-200 to-blue-200 bg-clip-text text-transparent tracking-tight mb-4">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-gradient-to-br from-gray-900/95 to-gray-950/95 backdrop-blur-xl p-6 sm:p-8 lg:p-12 rounded-3xl border border-gray-700/50 shadow-2xl">
                  <form className="space-y-6 sm:space-y-8">
                          ...
                          <label key={i} className="relative cursor-pointer group">
                            ...
                            <div className="bg-gray-800/50 border-2 border-gray-600 peer-checked:border-blue-500 peer-checked:bg-blue-500/10 rounded-xl p-4 transition-all duration-300 group-hover:border-gray-500">
                              <div className="flex items-center justify-between mb-2">
                                <span className="font-semibold text-white text-sm sm:text-base">{category.title}</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-3">
                        ...
                        <input
                          type="date"
                          className="w-full p-3 sm:p-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 focus:outline-none transition-all duration-300"
                      ...
                      <div className="space-y-3">
                        ...
                        <select className="w-full p-3 sm:p-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 focus:outline-none transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-3">
                        ...
                        <input
                          ...
                          className="w-full p-3 sm:p-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 focus:outline-none transition-all duration-300"
                        />
                      </div>
                      <div className="space-y-3">
                        <label className="text-white font-medium flex items-center gap-2 text-sm sm:text-base">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full p-3 sm:p-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 focus:outline-none transition-all duration-300 resize-none"
                      ></textarea>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full p-3 sm:p-4 bg-gray-800/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 focus:outline-none transition-all duration-300 resize-none"
                      ></textarea>
                    </div>
        ...
        <section id="services" className="py-12 sm:py-16 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight text-center mb-12">
              Our Services
            </h2>
            {services.map((service, i) => (
              <div
                ...
                className={`mb-12 sm:mb-16 service-item ${service.layout === "overlay" ? "relative" : ""}`}
              >
                {service.layout === "overlay" ? (
                  <div className="relative rounded overflow-hidden">
                    <Image
                      ...
                      width={1280}
                      height={720}
                      className="w-full h-[300px] sm:h-[400px] md:h-[450px] object-cover opacity-40"
                      priority={i < 3}
                    />
                    <div className="absolute bottom-0 left-0 p-4 sm:p-6 pt-8 sm:pt-12">
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-blue-400 mb-4 service-animate slideInFromBottom">
                        {service.title}
                      </h3>
                      <p className="text-gray-200 text-sm sm:text-base max-w-2xl service-animate slideInFromBottom delay-200">
                        {service.description}
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className={`flex flex-col lg:flex-row gap-6 sm:gap-8 items-center ${service.layoutDirection === "right" ? "lg:flex-row-reverse" : ""}`}>
                    <div className="w-full lg:w-2/5 service-animate slideInFromLeft">
                      <Image
                        ...
                        width={800}
                        height={1000}
                        className="w-full max-w-[90vw] sm:max-w-[550px] mx-auto h-[200px] sm:h-[250px] md:h-[270px] object-cover shadow-lg"
                        priority={i < 3}
                      />
                    </div>
                    <div className={`w-full lg:w-3/5 service-animate ${service.layoutDirection === "right" ? "slideInFromRight" : "slideInFromLeft"}`}>
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-blue-400 mb-4 text-center lg:text-left">
                        {service.title}
                      </h3>
                      <p className="text-gray-200 text-sm sm:text-base text-center lg:text-left leading-relaxed">
                        {service.description}
                      </p>
                    </div>
                  </div>
        ...
        {/* About Section */}
        <section id="about" ref={aboutSectionRef} className="py-12 sm:py-16 px-4 sm:px-6 bg-gradient-to-b from-black to-blue-900/30">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="mb-8">
              <Image
                ...
                width={700}
                height={500}
                className="mx-auto rounded-2xl shadow-2xl transition-all duration-700 ease-in-out hover:shadow-blue-500/50 w-full max-w-[90vw] sm:max-w-[700px]"
            ...
            {/* Title */}
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6 animate-fadeIn">
              About Blue Moon
            </h2>

            {/* Decorative Divider */}
            <div className="w-24 h-1 bg-gradient-to-r from-blue-400 to-blue-600 mx-auto mb-8 sm:mb-10 rounded-full"></div>

            {/* Description */}
            <p className="text-base sm:text-lg md:text-xl text-gray-200 max-w-3xl mx-auto mb-12 leading-relaxed font-light animate-fadeIn delay-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-3xl mx-auto">
              <div className="bg-gray-950/60 backdrop-blur-xl p-6 rounded-3xl border border-gray-700/50 shadow-xl hover:border-blue-500/70 hover:shadow-blue-500/30 transition-all duration-300 animate-fadeIn delay-200">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-blue-400 mb-4">Our Commitment</h3>
              ...
              <div className="bg-gray-950/60 backdrop-blur-xl p-6 rounded-3xl border border-gray-700/50 shadow-xl hover:border-blue-500/70 hover:shadow-blue-500/30 transition-all duration-300 animate-fadeIn delay-300">
                <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-blue-400 mb-4">Our Values</h3>
                <p className="text-gray-200 text-sm sm:text-base leading-relaxed font-light">
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
          {/* Animated Background Elements */}
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-1/4 left-1/4 w-48 sm:w-72 h-48 sm:h-72 bg-blue-500/10 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute bottom-1/3 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="space-y-6 sm:space-y-8">
                <div className="space-y-4">
                  ...
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold bg-gradient-to-r from-white via-blue-200 to-cyan-200 bg-clip-text text-transparent leading-tight">
                    Ready for Your Next
                ...
                <div className="relative group">
                  ...
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 backdrop-blur-sm">
                    <Image
                      ...
                      width={600}
                      height={400}
                      className="w-full h-[200px] sm:h-[250px] md:h-[300px] object-cover group-hover:scale-105 transition-transform duration-300"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent"></div>
                    <div className="absolute bottom-4 left-4 right-4">
                      <p className="text-white font-semibold text-sm sm:text-base md:text-lg">Blue Moon Car Wash</p>
                      <p className="text-blue-300 text-xs sm:text-sm">Professional Mobile Detailing</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-1 gap-4">
                  <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm sm:text-base">Call or WhatsApp</h4>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl p-6 sm:p-8 lg:p-10 rounded-3xl border border-white/10 shadow-2xl">
                  <div className="flex items-center gap-3 mb-8">
                    <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center">
                      <Send className="w-5 h-5 text-white" />
                    </div>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">Send Us a Message</h3>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full p-3 sm:p-4 rounded-xl bg-white/5 border transition-all duration-300 text-white placeholder-gray-400 focus:outline-none focus:scale-105 ${
                          focusedField === 'name' 
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onBlur={() => setFocusedField(null)}
                        className={`w-full p-3 sm:p-4 rounded-xl bg-white/5 border transition-all duration-300 text-white placeholder-gray-400 resize-none focus:outline-none focus:scale-105 ${
